...
@Component({
    ...
    template: `
        <style>
            .treegrid-ctpl-normal
            {
                width: 850px;
                height: 325px;
            }
            .treegrid-ctpl-normal .iui-treegrid-expand-box
            {
                margin-top: -3px;
            }
            .treegrid-ctpl-item-label
            {
        ...
        <h2 class="feature-title">TreeGrid / Different Cell Templates</h2>
        <div class="feature-content">
            ...
            <div class="feature-help" style="width:850px">
                ...
                <p><span class="initial-space"></span>For more information check out the source code of this sample (<i>treegrid/treegrid-cell-templates.ts</i>) file.</p> 
            </div>
        </div>
    `,
...
export class TreeGridCellTemplatesSample {
    ...
    constructor(){
        ...
        this.columns = [
            ...
            { id: 4, headerText: "Change %", width: 100, minWidth: 120, headerAlignment: 'center' },
        ...
        this.rows = [
            ...
            { 
                id: 4,
                text: "South America",
                cells: [{ cid: 1, text: "South America" }],
                rows: [
                    { 
                        id: 41,
                        pid: 4,
