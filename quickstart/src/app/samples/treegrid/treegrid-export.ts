...
@Component({
    ...
    template: `
        <style>
            .treegrid-expcsv-normal
            {
                float: left;
                width: 675px;
                height: 300px;
            }
            .treegrid-expcsv-button
            {
                margin: 5px 0;
                padding: 3px;
                width: 125px;
        ...
        <h2 class="feature-title">TreeGrid / Export to CSV or JSON</h2>
        <div class="feature-content" style="width:900px;">
            <div #application>
                <iui-treegrid [columns]="columns" [rows]="rows" [controlStyle]="gridStyle" [showFooter]="false" (columnClick)="onColumnClick($event)" #treegrid>
                ...
                <div class="control-panel">
                    <button class="treegrid-expcsv-button" (click)="exportCSV()">Export as CSV</button>
                    <button class="treegrid-expcsv-button" (click)="exportJSON()">Export as JSON</button>
                </div>
            </div>
            <br style="clear:both;"/>
            <div class="feature-help" style="width:800px;">
                ...
                <ul class="feature-points">
                    ...
                    <li><span style="color:#c60d0d">exportToJSON(columnFields, rowFields, spacing, flat)</span> - exports data to a JSON formatted string</li>
                </ul>
                ...
                <p><span class="initial-space"></span>For more information check out the source code of this sample (<i>treegrid/treegrid-export.ts</i>) file.</p> 
            </div>
        </div>
    `,
...
export class TreeGridExportSample {
    ...
    exportJSON(){
        let data = this.treegrid.exportToJSON();
        console.log(data);
    }

    exportCSV(){
        let data = this.treegrid.exportToCSV();
