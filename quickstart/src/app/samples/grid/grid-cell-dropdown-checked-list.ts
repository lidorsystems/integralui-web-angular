...
@Component({
    ...
    template: `
        <style>
            .grid-ccmb-adv-normal
            {
                width: 900px;
                height: 325px;
            }
            .grid-ccmb-adv-normal .iui-treegrid-expand-box
            {
                margin-top: -3px;
            }
            .grid-ccmb-adv-item-label
            {
            ...
            .grid-ccmb-adv-item-drop-mark
            {
                float: right;
            }
            .grid-ccmb-adv-item-drop-mark span
            {
        ...
        <h2 class="feature-title">Grid / Cell with DropDown Checked List</h2>
        <div class="feature-content">
                        ...
                        <div [ngSwitch]="cell.cid">
                            ...
                            <div *ngSwitchCase="4">
                                <div [iuiDropDown]="cell.dropdown" (dropDownOpen)="onDropDownOpen($event, cell)" #dropdown>
                                    <div class="grid-ccmb-adv-item-drop-mark"><span></span></div>
                                    <span class="grid-ccmb-adv-item-label">{{cell.text}}</span> 
            ...
            <div class="feature-help" style="width:900px">
                <p><span class="initial-space"></span>An example of a Grid cell with a dropdown component. This is a advanced version of <a routerLink="../cell-dropdown">Grid Cell with DropDown List</a> sample.</p>
                ...
                <p><span class="initial-space"></span>For more information check out the source code of this sample (<i>grid/grid-cell-dropdown-checked-list.ts</i>) file.</p> 
            </div>
        </div>
    `,
    encapsulation: ViewEncapsulation.None
})
export class GridCellDropDownCheckedListSample {
    ...
    constructor(){
        ...
        this.columns = [
            { id: 1, headerText: "Title", width: 260 },
        ...
        this.rows = [
            { 
                id: 1,
                text: "Inception",
                cells: [{ cid: 1, text: "Inception" }, { cid: 2, value: true }, { cid: 3, text: "2010" }, { cid: 4, text: "Action, Mystery, Sci-Fi" }, { cid: 5, text: "8.8" }, { cid: 6, text: "16 Jul 2010" } ]
            },
            { 
                id: 2,
                text: "Gravity",
            ...
            { 
                id: 4,
                text: "Toy Story 3",
                cells: [{ cid: 1, text: "Toy Story 3" }, { cid: 2, value: true }, { cid: 3, text: "2010" }, { cid: 4, text: "Animation, Adventure, Comedy" }, { cid: 5, text: "8.4" }, { cid: 6, text: "18 Jun 2010" } ]
            },
            { 
                id: 5,
                text: "The Wolf of Wall Street",
                cells: [{ cid: 1, text: "The Wolf of Wall Street" }, { cid: 2, value: true }, { cid: 3, text: "2013" }, { cid: 4, text: "Biography, Comedy, Crime" }, { cid: 5, text: "8.2" }, { cid: 6, text: "25 Dec 2013" } ]
            },
            { 
                id: 6,
                text: "The Town",
            ...
            { 
                id: 7,
                text: "Nightcrawler",
                cells: [{ cid: 1, text: "Nightcrawler" }, { cid: 2, value: true }, { cid: 3, text: "2014" }, { cid: 4, text: "Crime, Thriller" }, { cid: 5, text: "7.9" }, { cid: 6, text: "31 Oct 2014" } ]
            },
            { 
                id: 8,
                text: "Locke",
            ...
            { 
                id: 9,
                text: "Prometheus",
                cells: [{ cid: 1, text: "Prometheus" }, { cid: 2, value: true }, { cid: 3, text: "2012" }, { cid: 4, text: "Adventure, Mystery, Sci-Fi " }, { cid: 5, text: "7.0" }, { cid: 6, text: "08 Jun 2012" } ]
            },
            { 
                id: 10,
                text: "The Social Network",
                cells: [{ cid: 1, text: "The Social Network" }, { cid: 2, value: true }, { cid: 3, text: "2010" }, { cid: 4, text: "Biography, Drama" }, { cid: 5, text: "7.8" }, { cid: 6, text: "01 Oct 2010" } ]
            },
            { 
                id: 11,
                text: "The Conjuring",
            ...
            { 
                ...
                cells: [{ cid: 1, text: "The Dark Knight Rises" }, { cid: 2, value: true }, { cid: 3, text: "2012" }, { cid: 4, text: "Action, Thriller" }, { cid: 5, text: "8.5" }, { cid: 6, text: "20 Jul 2012" } ]
            },
            { 
                id: 18,
            ...
            { 
                ...
                cells: [{ cid: 1, text: "Dawn of the Planet of the Apes" }, { cid: 2, value: true }, { cid: 3, text: "2014" }, { cid: 4, text: "Action, Drama, Sci-Fi" }, { cid: 5, text: "7.7" }, { cid: 6, text: "11 Jul 2014" } ]
            },
            { 
                id: 20,
                text: "Frozen",
            ...
            { 
                ...
                cells: [{ cid: 1, text: "Edge of Tomorrow" }, { cid: 2, value: true }, { cid: 3, text: "2014" }, { cid: 4, text: "Action, Adventure, Mystery" }, { cid: 5, text: "7.9" }, { cid: 6, text: "06 Jun 2014" } ]
            },
            { 
                id: 22,
                text: "Interstellar",
            ...
            { 
                id: 24,
                text: "Shutter Island",
                cells: [{ cid: 1, text: "Shutter Island" }, { cid: 2, value: true }, { cid: 3, text: "2010" }, { cid: 4, text: "Mystery, Thriller " }, { cid: 5, text: "8.1" }, { cid: 6, text: "19 Feb 2010" } ]
            },
            { 
                id: 25,
