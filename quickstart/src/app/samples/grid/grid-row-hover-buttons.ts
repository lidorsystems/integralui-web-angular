...
@Component({
    ...
    template: `
        <style>
            ...
            .grid-rwhov-normal .iui-grid-expand-box
            {
                margin: -1px 7px 0 0;
            }
            .grid-rwhov-normal .iui-grid-row-hovered
            {
                background-color: #f5f5f5;
            }
            .grid-rwhov-normal .iui-grid-row-selected
            {
                background-color: #e5e5e5;
                color: black;
            }

            .grid-rwhov-cell-label
            {
                display: inline-block;
                margin-top: 5px;
                padding: 1px 0;
            }
            .grid-rwhov-normal .iui-editor-dropdown-button, .grid-rwhov-normal .iui-editor-label
            {
                margin-top: 3px;
            }
            ...
            .grid-rwhov-cell-favorite-selected {
        ...
        <h2 class="feature-title" style="margin-left:0">Grid / Show Buttons while Row is Hovered</h2>
        <div class="feature-content">
            <div #application>
                <iui-grid [appRef]="applicationRef" [controlStyle]="gridStyle" [columns]="columns" [rows]="rows" [rowHeight]="30" [showFooter]="false" [gridLines]="gridLines" [showHoverRow]="isHoverRowAllowed" #grid>
            ...
            <div class="feature-help">
                ...
                <p><span class="initial-space"></span>You can add custom content to the row-hover template. When mouse is moved over the row, this content wil appear. By default the content in the row-hover template appears on the right side of the grid row. This is set in CSS as part of the <span style="color:#c60d0d">iui-grid-block-hover</span> class (part of the integralui.grid-default.css style sheet). You can modify it so that it will appear on the left side or in any other way you want. The content will always appear on top of the row cells, over the grid row.</p>
                ...
                <p><span class="initial-space"></span>For more information check out the source code of this sample (<i>grid/grid-row-hover-buttons.ts</i>) file.</p> 
            </div>
        </div>
    `,
    encapsulation: ViewEncapsulation.None
})
export class GridRowHoverButtonsSample {
