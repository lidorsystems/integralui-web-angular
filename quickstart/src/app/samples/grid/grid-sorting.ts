...
@Component({
    ...
    template: `
        ...
        <h2 class="feature-title">Grid / Sorting</h2>
        <div class="feature-content">
            ...
            <div class="feature-help" style="width:800px">
                ...
                <p><span class="initial-space"></span>For columns which cells contains custom values, a <span style="color:#c60d0d">comparer</span> function is required. In case of this example, 3rd column contains date values, and a custom comparer function is created and applied to the Grid.</p>
                ...
                <ul class="feature-points" style="padding-bottom:10px;width:800px">
                    ...
                    <li><span style="color:#c60d0d">sort</span> a method which sorts the Grid rows based on applied order for specified column</li>
                </ul>
                <p><span class="initial-space"></span>For more information check out the source code of this sample (<i>grid/grid-sorting.ts</i>) file.</p> 
            </div>
        </div>
    `,
