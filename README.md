...
This is Trial version of the product, currently in BETA v0.9.012. All features are fully functional, except that each component displays a pop-up trial window.
