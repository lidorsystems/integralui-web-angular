...
export declare class IntegralUIBaseList extends IntegralUIBaseComponent {
    ...
    protected isDropAllowed(sourceData: any, targetItem: any, dropPos: any): boolean;
    protected processDragStart(e: any, item: any): void;
    protected processDragOver(e: any, item?: any, itemBounds?: any, flag?: any): void;
    ...
    protected isComponentIndexInRange(index: any): boolean;
    ...
    protected processSelection(e: any, item: any, value?: any): void;
    selectedItems(items: Array<any>): void;
