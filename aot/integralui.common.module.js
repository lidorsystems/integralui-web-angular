...
import { IntegralUIDropDown, IntegralUIDropDownComponent } from './directives/integralui.dropdown';
...
export { IntegralUICommonModule };
IntegralUICommonModule.decorators = [
    { type: NgModule, args: [{
                imports: [CommonModule, FormsModule, IntegralUICoreModule],
                declarations: [
                    IntegralUIComboBox,
                    IntegralUIDropDown,
                    IntegralUIDropDownComponent,
                    IntegralUIFrame,
                    IntegralUIListItem,
                    IntegralUIPaginator,
                    IntegralUIRange,
                ...
                entryComponents: [IntegralUIDropDownComponent, IntegralUITooltipComponent],
            },] },
];
/** @nocollapse */
IntegralUICommonModule.ctorParameters = function () { return []; };
